...
```mermaid
graph TD
    A["1. PRECISE PROMPT<br/>(Architectural Rules & Explicit Constraints)"] --> B["2. AI GENERATION<br/>(Component Code & Automated Test Suite)"]
    B --> C["3. AUTOMATED CHECKS<br/>(TypeScript typecheck & Vitest unit suite)"]
    C --> D["4. HUMAN CODE REVIEW<br/>(Line-by-line audit: CJS/ESM, ReDoS, XSS, Unmount Leaks, Focus)"]
    D --> E["5. RULE CAPTURE & DEPLOYMENT<br/>(Persist to CLAUDE.md & merge clean code)"]
```
...
* **Location in Repository:** [`WORKFLOW.md`](file:///c:/Users/PC-039/OneDrive/Documents/flyrank%20directory/frontend-ai-capstone/frontend-ai-capstone/WORKFLOW.md) (original lines 3–9, 29–35, 39–43, 47–48) & Commit `5799962` on branch `workflow-vague`.
...
* **Location in Repository:** [`WORKFLOW.md`](file:///c:/Users/PC-039/OneDrive/Documents/flyrank%20directory/frontend-ai-capstone/frontend-ai-capstone/WORKFLOW.md) (original lines 10–26, 31–35, 39–43, 48–53), [`CLAUDE.md`](file:///c:/Users/PC-039/OneDrive/Documents/flyrank%20directory/frontend-ai-capstone/frontend-ai-capstone/CLAUDE.md) (lines 22–25), & Commits `df9cd68` / `8e52079` on branch `workflow-precise`.
...
* **AI Output:** [`components/ui/CopyButton.tsx`](file:///c:/Users/PC-039/OneDrive/Documents/flyrank%20directory/frontend-ai-capstone/frontend-ai-capstone/components/ui/CopyButton.tsx) and [`tests/components/CopyButton.test.tsx`](file:///c:/Users/PC-039/OneDrive/Documents/flyrank%20directory/frontend-ai-capstone/frontend-ai-capstone/tests/components/CopyButton.test.tsx).
...
* **Location in Repository:** [`components/ui/CopyButton.tsx`](file:///c:/Users/PC-039/OneDrive/Documents/flyrank%20directory/frontend-ai-capstone/frontend-ai-capstone/components/ui/CopyButton.tsx) & [`tests/components/CopyButton.test.tsx`](file:///c:/Users/PC-039/OneDrive/Documents/flyrank%20directory/frontend-ai-capstone/frontend-ai-capstone/tests/components/CopyButton.test.tsx).
...
* **AI Output:** [`lib/search-filter.ts`](file:///c:/Users/PC-039/OneDrive/Documents/flyrank%20directory/frontend-ai-capstone/frontend-ai-capstone/lib/search-filter.ts) and [`tests/lib/search-filter.test.ts`](file:///c:/Users/PC-039/OneDrive/Documents/flyrank%20directory/frontend-ai-capstone/frontend-ai-capstone/tests/lib/search-filter.test.ts).
* **Automated Verification:**
  * `npm run typecheck` (`tsc --noEmit`): Exit code 0 (PASS).
...
* **Location in Repository:** [`lib/search-filter.ts`](file:///c:/Users/PC-039/OneDrive/Documents/flyrank%20directory/frontend-ai-capstone/frontend-ai-capstone/lib/search-filter.ts) & [`tests/lib/search-filter.test.ts`](file:///c:/Users/PC-039/OneDrive/Documents/flyrank%20directory/frontend-ai-capstone/frontend-ai-capstone/tests/lib/search-filter.test.ts).
...
* **AI Output:** [`lib/use-focus-trap.ts`](file:///c:/Users/PC-039/OneDrive/Documents/flyrank%20directory/frontend-ai-capstone/frontend-ai-capstone/lib/use-focus-trap.ts) and [`tests/lib/use-focus-trap.test.tsx`](file:///c:/Users/PC-039/OneDrive/Documents/flyrank%20directory/frontend-ai-capstone/frontend-ai-capstone/tests/lib/use-focus-trap.test.tsx).
* **Automated Verification:**
  * `npm run typecheck` (`tsc --noEmit`): Exit code 0 (PASS).
  * `npx vitest run tests/lib/search-filter.test.ts tests/components/CopyButton.test.tsx`: All tests passed (PASS).
...
* **Location in Repository:** [`lib/use-focus-trap.ts`](file:///c:/Users/PC-039/OneDrive/Documents/flyrank%20directory/frontend-ai-capstone/frontend-ai-capstone/lib/use-focus-trap.ts) & [`tests/lib/use-focus-trap.test.tsx`](file:///c:/Users/PC-039/OneDrive/Documents/flyrank%20directory/frontend-ai-capstone/frontend-ai-capstone/tests/lib/use-focus-trap.test.tsx).
...
2. **Zero production regressions:** Passed 25 out of 25 unit tests across active test suites with zero TypeScript errors.
